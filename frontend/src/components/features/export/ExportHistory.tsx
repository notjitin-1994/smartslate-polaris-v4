...
/**
* React component that displays and manages export history (load, download, delete, clear).
* @example
* ExportHistory('my-class')
* <div>Export History UI</div>
* @param {{string}} {{className}} - Additional CSS class names to apply to the root container.
* @returns {{JSX.Element}} A React element rendering the export history UI based on stored history and loading state.
**/
