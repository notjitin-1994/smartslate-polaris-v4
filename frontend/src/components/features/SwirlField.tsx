...
export const SwirlField = memo(
  ({
    ...
    useEffect(() => {
      ...
      /**
      * Animation frame step handler that updates swirl positions and connection lines, limits update frequency for performance, writes transforms/attributes to DOM/SVG, and schedules the next animation frame.
      * @example
      * step(1234)
      * undefined
      * @param {number} ts - The current timestamp (DOMHighResTimeStamp) passed from requestAnimationFrame, in milliseconds.
      * @returns {void} No return value; updates state/DOM and requests the next animation frame.
      **/
