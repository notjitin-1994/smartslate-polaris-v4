...
/**
* Render a modal dialog that displays a conflict, offers resolution strategies, and invokes callbacks to resolve or cancel.
* @example
* ConflictResolutionDialog({isOpen: true, onClose: () => {}, onResolve: (strategy) => {}, conflict: {/*...*/
export function ConflictResolutionDialog({
  ...
  /**
  * Trigger the selected conflict resolution strategy, call onResolve and close the dialog while managing resolving state and handling errors.
  * @example
  * sync()
  * undefined
  * @returns {void} Performs resolution side effects and does not return a value.
  */
