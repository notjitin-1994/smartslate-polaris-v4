...
/**
* Renders a visual progress tracker for a multi-section form, including overall percentage, per-section indicators, milestones, and a completion message.
* @example
* ProgressTracker({ totalSections: 8, completedSections: 3, currentSection: 4 })
* <div>...JSX element representing the progress tracker...</div>
* @param {number} totalSections - Total number of sections in the form.
* @param {number} completedSections - Number of sections that have been completed.
* @param {number} currentSection - 1-based index of the currently active section.
* @param {string} className - Optional additional CSS class names to apply to the root container.
* @param {boolean} showPercentage - Optional flag to show the numeric percentage; defaults to true.
* @param {boolean} showSections - Optional flag to show per-section indicators; defaults to true.
* @returns {JSX.Element} Rendered React element for the progress tracker component.
**/
