...
export { useBlueprintStore as useBlueprintViewerStore } from './blueprintStore';
export { useBlueprintStore } from '../lib/stores/blueprintStore';
...
import { useBlueprintStore as useBlueprintViewerStore } from './blueprintStore';
