 ...
 * Users with 'developer' or 'admin' role can access admin dashboard
 */
...
/**
 * Check if user has admin access (developer or admin role)
 */
export async function checkAdminAccess(): Promise<{
  ...
  try {
    ...
    if (!isAdmin) {
      console.log('[AdminAuth] User does not have admin role');
      return {
        isAdmin: false,
        user: null,
