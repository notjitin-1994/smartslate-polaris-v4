 ...
 * 1. Gemini 3.1 Pro Primary - Cost-effective, fast
 * 2. Gemini 3.1 Pro Fallback - More capable, handles complex scenarios
 *
...
export interface ModelConfig {
  ...
  /** Priority order (1 = primary, 2 = fallback) */
  priority: 1 | 2;
  ...
  provider: ReturnType<typeof google>;
}
