...
/**
* Render a styled informational box used in the questionnaire UI.
* @example
* QuestionnaireInfoBox({ title: 'Tip', children: <span>Save your progress</span>, variant: 'tip' })
* <div>Rendered info box element</div>
* @param {{QuestionnaireInfoBoxProps}} {{props}} - Props object containing title, children, and optional variant (defaults to 'tip').
* @returns {{React.JSX.Element}} Rendered info box element.
**/
