...
/**
* Render a group of selectable radio-style cards for choosing a single option.
* @example
* RadioCardGroup({ label: 'Select an option', value: 'opt1', onChange: v => console.log(v), options: [{ value: 'opt1', label: 'Option 1', description: 'First option' }], required: false, disabled: false })
* @param {RadioCardGroupProps} props - Props object containing label, value, onChange, options, error, helpText, required, disabled and className.
* @returns {React.JSX.Element} Rendered RadioCardGroup component element.
**/
