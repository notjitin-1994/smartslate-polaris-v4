...
/**
* Renders a group of selectable pill-style checkboxes allowing multiple selections with optional max selection limit, disabled state, help text and error display.
* @example
* CheckboxPillGroup({ label: 'Fruits', value: ['apple'], onChange: v => {}, options: [{ label: 'Apple', value: 'apple' }], required: true })
* <JSX.Element />
* @param {CheckboxPillGroupProps} props - Props object for the CheckboxPillGroup component.
* @returns {React.JSX.Element} Rendered checkbox pill group as a JSX element.
**/
