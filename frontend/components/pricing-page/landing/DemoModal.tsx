  ...
  const featureOptions = [
    {
      id: 'ai-courses',
      name: 'AI & ML Courses',
      description: 'Advanced AI literacy and technical skills',
    },
    ...
    },
    {
      ...
      description: 'Tailored curriculum design',
    },
  ...
  return (
    ...
    >
      <div className="flex h-full max-h-[90vh] flex-col">
        {/* Header - Fixed */}
        <div className="p-4 pb-4 text-center sm:p-6">
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            transition={{ type: 'spring', duration: 0.5 }}
            className="from-primary-accent to-primary-accent-dark mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br"
          >
            <svg
          ...
          <h2 id="demo-modal-title" className="mb-2 text-xl font-bold md:text-2xl">
            Schedule Your Demo
          </h2>
          <p id="demo-modal-subtitle" className="text-secondary mx-auto max-w-md text-sm">
        ...
        {isSuccess ? (
          ...
          >
            ...
            <h3 className="mb-3 text-2xl font-semibold">Demo Scheduled Successfully!</h3>
            <p className="text-secondary mb-2">We've received your demo request.</p>
            <p className="text-secondary/70 text-sm">
              Our team will contact you within 24 hours to confirm your demo time and prepare a
          ...
          <form onSubmit={handleSubmit} className="flex flex-1 flex-col overflow-hidden">
            {/* Scrollable Content */}
            <div className="flex-1 space-y-6 overflow-y-auto px-4 pb-4 sm:px-6">
              {/* Contact Information */}
                  ...
                  options={[
                    {
                      ...
                      description: 'General platform walkthrough',
                    },
                    {
                      value: 'custom-demo',
                      label: 'Custom Demo',
                    ...
                    },
                    {
                      value: 'roi-workshop',
                      label: 'ROI Workshop',
                      description: 'Business case and ROI analysis',
                    },
                  ]}
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                <FormField
                  ...
                  required
                  options={[{ value: '', label: 'Select date' }, ...generateDateOptions()]}
                ...
                <FormField
                  ...
                  required
                  options={[{ value: '', label: 'Select time' }, ...generateTimeSlots()]}
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                  {featureOptions.map((option) => (
                    <label
                      key={option.id}
                      className={`flex min-h-[48px] cursor-pointer items-start rounded-lg border border-white/10 bg-white/5 p-3 backdrop-blur-sm transition-all duration-200 hover:border-white/20 hover:bg-white/10 ${formData.specificFeatures.includes(option.id) ? 'border-primary-accent bg-primary-accent/10' : ''} `}
                    >
                      <input
                        type="checkbox"
                      ...
                      <div className="flex-1">
                        <div className="text-primary text-sm font-medium">{option.name}</div>
            ...
            <div className="bg-background-dark/50 border-t border-white/10 p-4 backdrop-blur-sm sm:p-6">
