...
export function InteractiveBlueprintDashboard({
  ...
  return (
    ...
    >
      ...
      {/* Metrics Cards - Hidden on mobile/touch, visible on desktop only */}
      <motion.div
        variants={itemVariants}
        transition={{ duration: 0.5, delay: 0.3 }}
        className="hidden grid-cols-1 gap-4 sm:grid-cols-2 lg:grid lg:grid-cols-4"
      >
        {/* Duration Metric */}
        <div className="glass-card group relative overflow-hidden rounded-2xl p-6 transition-all">
