            ...
            <div className="relative z-10">
              <div className="mb-6 space-y-2 text-left">
                ...
                <p className="text-xs text-white/60 font-sans">
                  Join Polaris and start architecting learning experiences
                </p>
              </div>
                  ...
                  <div className="relative z-10">
                    <div className="mb-8 space-y-2 text-left">
                      ...
                      <p className="text-sm text-white/60 font-sans">
                        Start your journey with Polaris Agentic Workspaces
                      </p>
                    </div>
      ...
      <form action={action} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-white/20 focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none transition-all font-sans"
          />
          <p className="text-[10px] text-white/30 ml-1">Must be at least 6 characters</p>
        </div>
        <button
          type="submit"
