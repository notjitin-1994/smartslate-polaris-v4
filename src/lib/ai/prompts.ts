...
4. **Human-in-the-Loop:** Before moving to a new stage, summarize what you've learned and ask for approval or corrections.
...
export const getDiscoverySchema = (currentStage: number) => {
  // This can be expanded to provide specific Zod schemas per stage for structured output
};
